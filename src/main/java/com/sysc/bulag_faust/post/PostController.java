...
public class PostController {
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<PostResponse>> createPost(@Valid @RequestBody CreateDraftRequest request) {
    PostResponse post = postService.createDraft(request);
